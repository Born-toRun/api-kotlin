...
=== 랭크 목록 조회
operation::search-crew-rankings[snippets="http-request,http-response,response-fields"]
=== 크루원 랭크 목록 조회
operation::search-crew-member-rankings[snippets="http-request,http-response,response-fields"]
=== 등록
operation::create-crews[snippets="http-request,request-fields,http-response,response-fields"]
=== 수정
operation::modify-crews[snippets="http-request,path-parameters,request-fields,http-response"]
...
=== 나의 피드 목록 조회
operation::search-my-feeds[snippets="http-request,http-response,response-fields"]
...
=== 크루별 목록 조회
operation::search-crew-activities[snippets="http-request,path-parameters,query-parameters,http-response,response-fields"]
=== 상세 조회
...
=== 나의 참여 목록 조회
operation::search-my-participations[snippets="http-request,http-response,response-fields"]
=== 출석체크 가능한 모임 조회
operation::search-available-attendance-activity-exists[snippets="http-request,http-response,response-fields"]
...
== 피드백
=== 등록
operation::create-feedbacks[snippets="http-request,request-fields,http-response"]
